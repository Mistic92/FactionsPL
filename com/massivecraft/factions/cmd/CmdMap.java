	...
	public void perform()
	{
		if (this.argIsSet(0))
		{
			if (this.argAsBool(0, ! fme.isMapAutoUpdating()))
			{
				...
				if ( ! payForCommand(Conf.econCostMap, "aby wyswietlic mape", "do wyswietlania mapy")) return;

				fme.setMapAutoUpdating(true);
				msg("<i>Auto odswiezanie mapy <green>WLACZONE.");
			...
			else
			{
				...
				msg("<i>Auto odswiezanie mapy <red>WYLACZONE.");
			}
		}
		else
		{
