...
public class CmdMoneyTransferFp extends FCommand
{
	...
	public void perform()
	{
		...
		if (success && Conf.logMoneyTransactions)
			P.p.log(ChatColor.stripColor(P.p.txt.parse("%s przelal %s z miasta \"%s\" do gracza \"%s\"", fme.getName(), Econ.moneyString(amount), from.describeTo(null), to.describeTo(null))));
	}
}
